<?php
  ...
  array("FBApplication","FBPermission", "FBCaptcha","FBFriendSelector","FBBoard","FBBookmark","FBChatInvite","FBComments","FBFeed", "FBMultiFriendInput","FBSilverlight","FBSwf","FBMp3","FBIframe","FBFlv","FBShareButton"),"facebook/facebook.inc.php");
