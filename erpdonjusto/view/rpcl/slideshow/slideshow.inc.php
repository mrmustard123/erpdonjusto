...
*  SlideShow component
*
*  Copyright (c) 2010 qadram software S.L. <support@qadram.com>
*  http://www.qadram.com
*
...
class SlideShow extends Control
{
    ...
    */
	...
	<script type="text/javascript" src="<?php echo RPCL_HTTP_PATH; ?>/slideshow/fancybox/jquery.mousewheel-3.0.2.pack.js"></script>
	<script type="text/javascript" src="<?php echo RPCL_HTTP_PATH; ?>/slideshow/fancybox/jquery.fancybox-1.3.1.js"></script>
	<link rel="stylesheet" type="text/css" href="<?php echo RPCL_HTTP_PATH; ?>/slideshow/fancybox/jquery.fancybox-1.3.1.css" media="screen" />
    <?php
      }
