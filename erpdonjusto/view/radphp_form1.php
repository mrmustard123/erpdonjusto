...
<form style="margin-bottom: 0" id="view_supply_price" name="view_supply_price" method="post"   action="/erpdonjusto/view/view_supply_price.php">
<input type="hidden" name="serverevent" value="">
<input type="hidden" id="supply_name1SubmitEvent" name="supply_name1SubmitEvent" value="" />
<input type="hidden" name="price1_hidden" value="2.97000">
<input type="hidden" id="Button2SubmitEvent" name="Button2SubmitEvent" value="" />
...
<div id="supply_id1" style=" font-family: Tahoma; font-size: 11px;  cursor: default;height:13px;width:75px;"   >6</div>
</div>
...
<input type="hidden" name="price1_key[supply_id]" value="6" /><input type="text" id="price1" onchange="return price1_updatehidden(event)" name="price1" value="7.00000" style=" font-family: Tahoma; font-size: 11px;  cursor: default;height:20px;width:121px;"    tabindex="0"    />
</div>
...
</form></div> <!--end div_target--></div> <!--end wrapper--></body>
</html>
