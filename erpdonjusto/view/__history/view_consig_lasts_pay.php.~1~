...
//Class definition
class view_consig_lasts_pay extends Page
{
    ...
    public $Label5 = null;
    public $Label6 = null;
    function view_consig_lasts_payShow($sender, $params)
    {
      echo '<a href="../index.php?action=home">Inicio</a>';
    }
    function view_consig_lasts_payShowHeader($sender, $params)
    {
...
global $view_consig_lasts_pay;

//Creates the form
$view_consig_lasts_pay=new view_consig_lasts_pay($application);

//Read from resource file
$view_consig_lasts_pay->loadResource(__FILE__);

//Shows the form
$view_consig_lasts_pay->show();
