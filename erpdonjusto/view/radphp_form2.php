...
<form  style="margin-bottom: 0" id="view_supply_price" name="view_supply_price" method="post"   action="/erpdonjusto/view/view_supply_price.php" > <!--adicionado-->
<input type="hidden" name="serverevent" value=""> <!--adicionado-->
<input type="hidden" id="supply_name1SubmitEvent" name="supply_name1SubmitEvent" value="" />
<input type="hidden" name="price1_hidden" value="">
...
</div> <!--end div_target--></div> <!--end wrapper--></body>
</html>
