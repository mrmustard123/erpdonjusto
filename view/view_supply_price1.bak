...
class view_supply_price extends Page
{
    ...
    function Button1Click($sender, $params)
    {
           ...
           $sql = "UPDATE prod_cost_prod SET cost_value='".$cost_value."' WHERE prod_cost_id=".$prod_cost_id." #";
...
#Panel2_outer {
    ...
    function Panel2AfterShow($sender, $params)
    {
      //echo 'ESTO ES PANEL2 AFTER SHOW';
    }
    function Panel2Show($sender, $params)
    {
      //echo 'ESTO ES PANEL2 ON SHOW';
      require "view_menu.php";
    }
    function Panel2BeforeShow($sender, $params)
    {
       //echo 'ESTO ES PANEL2 BEFORE SHOW';
    }
