        ...
        */
            function dumpLayoutContents($exclude=array())
            {
                switch($this->_type)
                {
                        ...
                        case XY_LAYOUT: $this->dumpXYLayout(intval($exclude)); break;
...
class Font extends Persistent
{
        ...
        *
        * @param ObjectFactory $dest Destination, where the new font settings are assigned to.
        */
        ...
        */
        ...
        function readCSSString()
        {
                ...
                switch($this->_variant)
                {
                        case vaNormal: $fontstyle="normal "; break;
                        case vaSmallCaps: $fontstyle="small-caps "; break;
                }
