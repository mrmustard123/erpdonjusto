...
class DataModule extends CustomPage
{
        ...
        * @see extractjscript()
        *
        * @param ObjectFactory $object Object to be added
        */
    ...
    function dumpHeaderJavascript($return_contents=false)
    {
        ...
        if ($output_enabled)
        {
                ...
                if ($this->_useajax)
                {
                        ...
                        {
                          global $xajax;
                          $sp=$xajax->getJavascript("",RPCL_HTTP_PATH."/xajax/xajax_js/xajax.js").$sp;
                        }
                }
                //
                if ($return_contents)
...
<?php
    ...
    * @return boolean
    */
    function getGenerateTable() { return $this->_generatetable; }
    function setGenerateTable($value) { $this->_generatetable=$value; }
...
//                $height="";
    ...
    function getGenerateDocument() { return $this->_generatedocument; }
    function setGenerateDocument($value) { $this->_generatedocument=$value; }
