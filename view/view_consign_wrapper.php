...
/*
File: view_consign_wrapper
Author: Leonardo G. Tellez Saucedo
Created on: 26 ago. de 2024 23:12:52
...
ESTO ES ON SHOW!ESTO ES ON BEFORE SHOW HEADER<html  DIR=ltr >
<head>
...
<input type="hidden" id="supply_name1SubmitEvent" name="supply_name1SubmitEvent" value="" /><input type="hidden" name="price1_hidden" value=""><input type="hidden" id="Button2SubmitEvent" name="Button2SubmitEvent" value="" /><input type="hidden" id="Button1SubmitEvent" name="Button1SubmitEvent" value="" />ESTO ES ON START BODY<style>
...
/*
        ...
        <nav id="sidebar"  style="background: #7386D5">
            <div class="sidebar-header" >
                <div style="float: left"><h3><a href="../index.php?action=home">Inicio</a></h3></div>
            </div>

            <div style="width: 100%; display: flex;"><span class="txt_company">Ap&iacute;cola<br/>"Don Justo"</span><img src="images/logo_adj.png" width="70em" height="70em" style="margin-left:2em;"/></div>
            ...
            <ul class="list-unstyled components">                
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu2">
                        ...
                        <li>
                            <a href="view_supply_price.php">&bullet;&nbsp;PRECIO DEL INSUMO</a>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu3">
                        ...
                        <li>
                            <!--a href="../index.php?action=consignaciones">&bullet;&nbsp;Consignaciones</a-->
                            <a href="view_consign_prod_wrapper.php">&bullet;&nbsp;Consignaciones</a>
                        </li>
                                              
                        <li>
                            <a href="view_new_consignee.php">&bullet;&nbsp;Nuevo Consignatario</a>
                        </li>
                                                
                        <li>
                            <a href="view_consig_lasts_mov.php">&bullet;&nbsp;ULTIMOS MOVIMIENTOS</a>
                        </li>
                                                
                        <li>
                            <a href="view_consig_lasts_pay.php">&bullet;&nbsp;ULTIMOS PAGOS</a>
                        </li>
                                                
                        <li>
                            <a href="view_consig_list.php">&bullet;&nbsp;LISTA DE CONSIGNATARIOS</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu4">
                        ...
                        <li>
                            <a href="view_consig_prod_sales_report1.php">&bullet;&nbsp;CONSULTA DE VENTAS X PRODUCTO PAGADAS</a>
                        </li>
                                                
                        <li>
                            <a href="view_consig_prod_sales_report3.php">&bullet;&nbsp;CONSULTA DE VENTAS X PRODUCTO SALIDAS</a>
                        </li>
                                                
                        <li>
                            <a href="view_budget_0002.php">&bullet;&nbsp;PRESUPUESTO</a>
                        </li>
                                                
                        <li>
                            <a href="view_income_outcome.php">&bullet;&nbsp;AHORRO VS. GASTO</a>
                        </li>
                                                   
                        <li>
                            <a href="view_farmacorps_mas_salida.php">&bullet;&nbsp;FARMACORPS CON M&Aacute;S SALIDAS(HIST&Oacute;RICO)</a>
                        </li>
                                                
                        <li>
                            <a href="view_farmacorps_mas_salida_a_60_dias.php">&bullet;&nbsp;FARMACORPS CON M&Aacute;S SALIDAS A 60 D&Iacute;AS</a>
                        </li>
                                                
                        <li>
                            <a href="view_consig_max_sprays_stock.php">&bullet;&nbsp;CONSIGNAT&Aacute;RIOS CON MAYOR STOCK DE SPRAYS</a>
                        </li>
                                                
                        <li>
                            <a href="view_salidas_farmacorp_x_mes.php">&bullet;&nbsp;SALIDAS FARMACORP X MES 2021</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pageSubmenu6">
                        ...
                        <li>
                            <a href="view_bitacora_list_wrapper.php">&bullet;&nbsp;Ver Bit&aacute;cora</a>
                        </li>
...
ESTO ES AFTER SHOW FOOTER</body>
</html>
