<?php
<object class="ViewConsigSalesProdReport2" name="ViewConsigSalesProdReport2" baseclass="Page">
  <property name="Background"></property>
  <property name="Caption">Conteo de productos vendidos</property>
  <property name="DocType">dtNone</property>
  <property name="Height">800</property>
  <property name="IsMaster">0</property>
  <property name="Name">ViewConsigSalesProdReport2</property>
  <property name="Width">360</property>
  <property name="OnShow">ViewConsigSalesProdReport2Show</property>
  <property name="OnShowHeader">ViewConsigSalesProdReport2ShowHeader</property>
  ...
  <object class="Query" name="Query1" >
    ...
    <property name="SQL"><![CDATA[a:1:{i:0;s:255:&quot;SELECT p.product_name, SUM(c.cant) AS 'cantidad',  SUM(c.unit_price*c.cant) as 'Total_Bs'  FROM `consig_prod` AS c INNER JOIN product AS p ON (c.product_id=p.product_id) WHERE c.consig_date BETWEEN ' ' AND ' ' AND c.mov_type = 'PAGO' GROUP BY c.product_id&quot;;}]]></property>
  </object>
</object>
?>
